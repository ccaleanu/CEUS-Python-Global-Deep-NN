...
# NASNetMobile.py
'''
Implementation of the NASNetMobile architecture.
Structure: INPUT --> ...
'''
...
class NASNetMobile:
    '''
    NASNetMobile Architecture implemented using tf.keras.applications
    '''
    ...
    def build(num_classes:int):
        ...
        '''
        Build the NASNetMobile architecture given the corresponding
        ...
        returns
        -------
            model: the NASNetMobile model compatible with given inputs
        '''
        # initialize model
